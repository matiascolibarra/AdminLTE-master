...
<head>
  ...
  <title>Tabla de Instructores</title>
...
echo  '<h3 class="card-title">Instructores</h3><br>';
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Nuevo Instructor</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form action="conexion-instructores.php" method="POST">
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="exampleInput2">Area</label>
                <input type="text" class="form-control" name="area" id="exampleInput2" placeholder="Ingresar Area...">
              </div>
            </div>
            <!-- /.card-body -->
